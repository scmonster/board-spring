...
public class BoardMapperTests {
	...
	/*
	 * @Test public void testDeletd() { log.info("DELETE COUNT: " +
	 * mapper.delete(3L)); }
	 */
	
	/*
	 * @Test public void testUpdate() { BoardVO board = new BoardVO(); //실행전 존재하는
	 * 번호인지 확인할 것 board.setBno(5L); board.setTitle("수정된 제목");
